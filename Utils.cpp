...
GLuint Utils::loadCubeMap(const char *mapDir) {
	GLuint textureRef;
	string xp = mapDir; xp = xp + "/xp.bmp";
	string xn = mapDir; xn = xn + "/xn.bmp";
	string yp = mapDir; yp = yp + "/yp.bmp";
	string yn = mapDir; yn = yn + "/yn.bmp";
	string zp = mapDir; zp = zp + "/zp.bmp";
	string zn = mapDir; zn = zn + "/zn.bmp";
